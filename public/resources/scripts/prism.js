...
Prism.languages.gherkin = {
    ...
    'feature': {
        pattern: /((?:^|\r?\n|\r)[ \t]*)(?:Ability|Ahoy matey!|Arwedd|Aspekt|Besigheid Behoefte|Business Need|Caracteristica|Característica|Egenskab|Egenskap|Eiginleiki|Feature|Fica|Fitur|Fonctionnalité|Fonksyonalite|Funcionalidade|Funcionalitat|Functionalitate|Functionalitate|Func?ionalitate|Functionaliteit|Fungsi|Funkcia|Funkcija|Funkcionalitate|Funkcionalnost|Funkcja|Funksie|Funktionalität|Funktionalitéit|Funzionalità|Hwaet|Hwæt|Jellemzo|Karakteristik|laH|Lastnost|Mak|Mogucnost|Mogucnost|Moznosti|Možnosti|OH HAI|Omadus|Ominaisuus|Osobina|Özellik|perbogh|poQbogh malja'|Potrzeba biznesowa|Požadavek|Požiadavka|Pretty much|Qap|Qu'meH 'ut|Savybe|Tính nang|Trajto|Vermoë|Vlastnost|Wlasciwosc|Znacilnost|???at?t?ta|?e?t?????a|?????????|?????????|???????|????????|??????????????|??????????|??????????????|???????|??????????|?????|?????|??????|??????|??????? ?? ?????|??????|??? ???|??????|??? ?????|????????|?????|??????|????????????????????|??????????|????????|??|?????|??|??):(?:[^:]+(?:\r?\n|\r|$))*/,
        lookbehind: true,
        inside: {
            'important': {
                pattern: /(:)[^\r\n]+/,
    ...
    'scenario': {
        pattern: /((?:^|\r?\n|\r)[ \t]*)(?:Abstract Scenario|Abstrakt Scenario|Achtergrond|Aer|Ær|Agtergrond|All y'all|Antecedentes|Antecedents|Atburðarás|Atburðarásir|Awww, look mate|B4|Background|Baggrund|Bakgrund|Bakgrunn|Bakgrunnur|Beispiele|Beispiller|B?i c?nh|Cefndir|Cenario|Cenário|Cenario de Fundo|Cenário de Fundo|Cenarios|Cenários|Contesto|Context|Contexte|Contexto|Conto|Contoh|Contone|Dæmi|Dasar|Dead men tell no tales|Delineacao do Cenario|Delineação do Cenário|Dis is what went down|D? li?u|Dyagram senaryo|Dyagram Senaryo|Egzanp|Ejemplos|Eksempler|Ekzemploj|Enghreifftiau|Esbozo do escenario|Escenari|Escenario|Esempi|Esquema de l'escenari|Esquema del escenario|Esquema do Cenario|Esquema do Cenário|Examples|EXAMPLZ|Exempel|Exemple|Exemples|Exemplos|First off|Fono|Forgatókönyv|Forgatókönyv vázlat|Fundo|Geçmis|ghantoH|Grundlage|Hannergrond|Háttér|Heave to|Istorik|Juhtumid|Keadaan|Khung k?ch b?n|Khung tình hu?ng|K?ch b?n|Koncept|Konsep skenario|Kontèks|Kontekst|Kontekstas|Konteksts|Kontext|Konturo de la scenaro|Latar Belakang|lut|lut chovnatlh|lutmey|Lýsing Atburðarásar|Lýsing Dæma|Menggariskan Senario|MISHUN|MISHUN SRSLY|mo'|Nácrt Scenára|Nácrt Scénáre|Nácrt Scenáru|Oris scenarija|Örnekler|Osnova|Osnova Scenára|Osnova scénáre|Osnutek|Ozadje|Paraugs|Pavyzdžiai|Példák|Piemeri|Plan du scénario|Plan du Scénario|Plan senaryo|Plan Senaryo|Plang vum Szenario|Pozadí|Pozadie|Pozadina|Príklady|Príklady|Primer|Primeri|Primjeri|Przyklady|Raamstsenaarium|Reckon it's like|Rerefons|Scenár|Scénár|Scenarie|Scenarij|Scenarijai|Scenarijaus šablonas|Scenariji|Scenarijs|Scenarijs pec parauga|Scenarijus|Scenario|Scénario|Scenario Amlinellol|Scenario Outline|Scenario Template|Scenariomal|Scenariomall|Scenarios|Scenariu|Scenariusz|Scenaro|Schema dello scenario|Se ðe|Se the|Se þe|Senario|Senaryo|Senaryo deskripsyon|Senaryo Deskripsyon|Senaryo taslagi|Shiver me timbers|Situacija|Situai|Situasie|Situasie Uiteensetting|Skenario|Skenario konsep|Skica|Structura scenariu|Structura scenariu|Struktura scenarija|Stsenaarium|Swa|Swa hwaer swa|Swa hwær swa|Szablon scenariusza|Szenario|Szenariogrundriss|Tapaukset|Tapaus|Tapausaihio|Taust|Tausta|Template Keadaan|Template Senario|Template Situai|The thing of it is|Tình hu?ng|Variantai|Voorbeelde|Voorbeelden|Wharrimean is|Yo\-ho\-ho|You'll wanna|Zalozenia|?a?ade??µata|?e????af? Se?a????|Se????a|Se?????|?p?ßa???|?????|????????|???????|????????|????????|??????|??????????|????????|???????????|???????????|????????|??????|???????|???????|????? ?? ????????|?????|????????? ?????????|????????? ????????|????????? ????????|????????|???????? ???????????|??????????? ????????|?????????|????????|????????|?????|????????|???????|???|????? ?????|?????|???????|????? ??????|?????|?? ????|?????|??????|???????|??????? ????|??????|???? ???? ?? ????|????????|????? ??|??????|????????|???????? ???????|?????????|????????|?????|????? ?????|????? ??? ????|??????|????????|????|???????|?????????|??????????|?????????|??????|????????|?????????????????????|??????????????|???????????????|??????|?????????????|?????????|??|????|???? ??|?|????|????|??????????|????????|??????????|????|?|??|??|????|??|????|??|????|??|????|??):[^:\r\n]*/,
        lookbehind: true,
        inside: {
            'important': {
                pattern: /(:)[^\r\n]*/,
    ...
    'atrule': {
        pattern: /((?:\r?\n|\r)[ \t]+)(?:'ach|'a|'ej|7|a|A také|A taktiež|A tiež|A zároven|Aber|Ac|Adott|Akkor|Ak|Aleshores|Ale|Ali|Allora|Alors|Als|Ama|Amennyiben|Amikor|Ampak|an|AN|Ananging|And y'all|And|Angenommen|Anrhegedig a|An|Apabila|Atès|Atesa|Atunci|Avast!|Aye|A|awer|Bagi|Banjur|Bet|Bi?t|Blimey!|Buh|But at the end of the day I reckon|But y'all|But|BUT|Cal|Când|Cando|Cand|Ce|Cuando|Ce|Ða ðe|Ða|Dadas|Dada|Dados|Dado|DaH ghu' bejlu'|dann|Dann|Dano|Dan|Dar|Dat fiind|Data|Date fiind|Date|Dati fiind|Dati|Dati fiind|Da?i fiind|Dato|DEN|Den youse gotta|Dengan|De|Diberi|Diyelim ki|Donada|Donat|Donitajo|Do|Dun|Duota|Ðurh|Eeldades|Ef|Eger ki|Entao|Então|Entón|Entonces|En|Epi|E|És|Etant donnée|Etant donné|Et|Étant données|Étant donnée|Étant donné|Etant données|Etant donnés|Étant donnés|Fakat|Gangway!|Gdy|Gegeben seien|Gegeben sei|Gegeven|Gegewe|ghu' noblu'|Gitt|Given y'all|Given|Givet|Givun|Ha|Cho|I CAN HAZ|In|Ir|It's just unbelievable|I|Ja|Jesli|Jezeli|Kadar|Kada|Kad|Kai|Kaj|Když|Ked|Kemudian|Ketika|Khi|Kiedy|Ko|Kuid|Kui|Kun|Lan|latlh|Le sa a|Let go and haul|Le|Lè sa a|Lè|Logo|Lorsqu'<|Lorsque|mä|Maar|Mais|Majac|Majd|Maka|Manawa|Mas|Ma|Menawa|Men|Mutta|Nalikaning|Nalika|Nanging|Når|När|Nato|Nhung|Niin|Njuk|O zaman|Og|Och|Oletetaan|Onda|Ond|Oraz|Pak|Pero|Però|Podano|Pokial|Pokud|Potem|Potom|Privzeto|Pryd|qaSDI'|Quando|Quand|Quan|Så|Sed|Se|Siis|Sipoze ke|Sipoze Ke|Sipoze|Si|Si|?i|Soit|Stel|Tada|Tad|Takrat|Tak|Tapi|Ter|Tetapi|Tha the|Tha|Then y'all|Then|Thì|Thurh|Toda|Too right|ugeholl|Und|Un|Và|vaj|Vendar|Ve|wann|Wanneer|WEN|Wenn|When y'all|When|Wtedy|Wun|Y'know|Yeah nah|Yna|Youse know like when|Youse know when youse got|Y|Za predpokladu|Za predpokladu|Zadani|Zadano|Zadan|Zadate|Zadato|Zakladajac|Zaradi|Zatati|Þa þe|Þa|Þá|Þegar|Þurh|????|?ed?µ????|?a?|?ta?|??te|? ?????|????|???|???|????|?|????|?????|????|?????|??|??|??????|????|????????|????|??????|??????|??????|?|?|? ???? ??|????|???|??????|?????|????|?????|?????|????????|?????|??|????|??????????, ??|??????????|?????|?????|??|?????|????|??|????|???|????|???|???|??|??????|???|????|?????|????|???|???|???|?? ???|??????|????|???|??|??|??|?????|??? ???|???|????|???|??????|?|???|??|???|??????|?????|??|???|???|??|??????|??|???|???|????|????? ??|????|??|??|???????|? ???????????|????|???????????|?????|????|????|??????|?????|???????????|????????|???????|???|?????|???|???<|???<|?<|??<|??<|??<|??<|???<|??<|???<|???<|???<|??<|??<|??<|??<|??<|??<|??<|??<|??<|??<|??<|??<|?<|?<|??<|??<|??<)(?=[ \t]+)/,
        lookbehind: true
    },
    'string': {
        pattern: /"(?:\\.|[^"\\\r\n])*"|'(?:\\.|[^'\\\r\n])*'/,
